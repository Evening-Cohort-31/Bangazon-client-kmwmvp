// Typography.js
// size: 1-6 (1 is largest) for Title and Subtitle
// Text color via className: "has-text-primary" | "has-text-danger" | "has-text-grey" etc.
// Custom theme: style={{ color: 'var(--color-primary)' }} or style={{ color: 'var(--color-secondary)' }}
