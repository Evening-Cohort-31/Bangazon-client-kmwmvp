...
**This is not currently in use in this project.** It is planned as a learning spike (ticket [#27](https://github.com/Evening-Cohort-31/Bangazon-client-kmwmvp/issues/27)) to explore whether it makes sense to adopt for this codebase.
...
This project is written in plain JavaScript (`.js` files). TypeScript is on the stretch goal list (ticket [#19](https://github.com/Evening-Cohort-31/Bangazon-client-kmwmvp/issues/19)) but is not in scope for the current sprint.
